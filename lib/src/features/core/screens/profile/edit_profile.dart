    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: FutureBuilder(
              future: ProfileController.to.getUserData(),
                            ...
                            Center(
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                    padding: const EdgeInsets.all(0), backgroundColor: Colors.red.withOpacity(0.2), foregroundColor: Colors.red, shape: const StadiumBorder(), side: BorderSide.none),
                                child: const Text(
                                  tDelete,
